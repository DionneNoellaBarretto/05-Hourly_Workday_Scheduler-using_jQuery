...
//console.log(hour);
   ...
   row.append(hour, userText,delBtn, saveBtn);
...
// save the activity when the save button is clicked in local storage
$('.save').on('click', function (event) {
    // prevent the save button from clicking more than once
    event.preventDefault();
    var userInput = $(this).siblings(".todo").val();
    var inputWhereabouts = $(this).siblings(".todo").attr("id");
    localStorage.setItem(inputWhereabouts , userInput);
});
